...
# Run 
ssh -i rsa/deploy_rsa.pem root@94.177.201.179 'docker-compose -f ~/deployed/BoltJwt/docker-compose.yml pull && docker-compose -f ~/deployed/BoltJwt/docker-compose.yml up -d'